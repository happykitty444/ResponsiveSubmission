...
function App() {
  return (
    <div className="App">
      ...
      <img src="" alt="screenshot of Vflea" />
      <h3>Accessibility</h3>
      ...
      <img src="" alt="screenshot of WebAIM" />
      <ul>
      ...
      <img src="" alt="Balsamiq Low Fidelity Wireframes"/>
      ...
      <img src="" alt="Figma High Fidelity Prototypes"/>
      ...
      <p>With a detailed high fidelity prototype it is simply a matter of putting in some work to build the website for real. I believe that
        ...
        <br/>
        <a href="url">Visit the Final Product Here!</a>
      </p>
      <img src="" alt="Screenshot of Final Website"/>
    </div>
  );
}
